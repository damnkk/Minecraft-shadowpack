...
// vec3(0.0392, 0.0549, 0.0667), // 0-1000
// vec3(0.0392, 0.0549, 0.0667), // 1000 - 2000
// vec3(0.0392, 0.0549, 0.0667), // 2000 - 3000
// vec3(0.0392, 0.0549, 0.0667), // 3000 - 4000
// vec3(0.0392, 0.0549, 0.0667), // 4000 - 5000
// vec3(0.0392, 0.0549, 0.0667), // 5000 - 6000
// vec3(0.0392, 0.0549, 0.0667), // 6000 - 7000
// vec3(0.0392, 0.0549, 0.0667), // 7000 - 8000
// vec3(0.0392, 0.0549, 0.0667), // 8000 - 9000
// vec3(0.0392, 0.0549, 0.0667), // 9000 - 10000
// vec3(0.0392, 0.0549, 0.0667), // 10000 - 11000
// vec3(0.0392, 0.0549, 0.0667), // 11000 - 12000
// vec3(0.0392, 0.0549, 0.0667), // 12000 - 13000
...
vec3 sunColorArr[24] = vec3[24](
    vec3(1.0, 1.0, 0.5),      // 0-1000
    vec3(1.0, 0.75, 0.5),    // 1000 - 2000
    vec3(1, 1, 0.7),      // 2000 - 3000
    vec3(1, 1, 0.8),      // 3000 - 4000
    vec3(1, 1, 0.8),      // 4000 - 5000 
    vec3(1, 1, 0.8),      // 5000 - 6000
    vec3(1, 1, 0.8),      // 6000 - 7000
    vec3(1, 1, 0.8),      // 7000 - 8000
    vec3(1, 1, 0.8),      // 8000 - 9000
    vec3(1, 1, 0.8),      // 9000 - 10000
    vec3(1, 1, 0.8),      // 10000 - 11000
    vec3(1, 1, 0.8),      // 11000 - 12000
    vec3(0.3, 0.5, 0.9),       // 12000 - 13000
